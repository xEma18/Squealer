<template> <!-- scrivo il codice html che il componente metterà in index.html -->
  <div id="app">
    <router-view></router-view> <!--qui è dove il router mette le componentei che vengono caricate in base al path richiesto-->
  </div>
</template>
