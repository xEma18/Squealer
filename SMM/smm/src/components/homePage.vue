<template>
  <div>
    ...
    <section id="navbar"><nav class="navbar is-black" role="navigation" aria-label="main navigation">
  ...
  <div id="navbarBasicExample" class="navbar-menu">
    ...
    <section id="Squeal">
      ...
      <div v-for="(squealItem, index) in squealsWithSpaces" :key="index" class="card ms-1" :id="'card-' + index">
        ...
        <footer class="is-centered">
          <button href="#" class="button is-dark" @click="modifyButton(index)">
            Visualizza commenti
          </button>
        </footer>
      </div>
